...
Process.prototype.start = function () {
	...
	getDrone(function(drone) {
		...
		proc.on('exit', self.processExit);
		proc.on('start', self.processStart);
		proc.on('stop', self.processStop);
		proc.on('restart', self.processRestart);
